...
#include "hardware_interface_pkg/diffbot_system.hpp"
...
namespace hardware_interface_pkg
{

  //
  // Parâmetros do robô (no src/omnicare_description/urdf/ros2_control.xacro) / interface com o MCU
  //
  ...
  // Write on MCU
  // 
  hardware_interface::return_type hardware_interface_pkg ::DiffBotSystemHardware::write(
      const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
  {
    ...
    comms_.set_motor_values(motor_l_counts_per_loop,motor_r_counts_per_loop,motor_b_counts_per_loop);
...
PLUGINLIB_EXPORT_CLASS(
    hardware_interface_pkg::DiffBotSystemHardware, hardware_interface::SystemInterface)
